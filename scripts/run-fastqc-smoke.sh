...
assert_summary_value "$OUTPUT_DIR/summary/fastqc-summary.tsv" "SINGLE_A" "r1_avg_quality" "8.5"
assert_summary_value "$OUTPUT_DIR/summary/fastqc-summary.tsv" "PAIRED_B" "r1_read_count" "2"
assert_summary_value "$OUTPUT_DIR/summary/fastqc-summary.tsv" "PAIRED_B" "r1_avg_quality" "9.5"
