    ...
    for (const [key, value] of Object.entries(obj)) {
      ...
      if (value && typeof value === 'object' && !Array.isArray(value)) {
        ...
        const fileValue = fileConfig
          ? getNestedValue(fileConfig as Record<string, unknown>, fullPath)
          : undefined;
...
export function loadConfig(forceReload: boolean = false): ResolvedConfig {
  ...
  let mergedConfig = deepMerge(DEFAULT_CONFIG as Record<string, unknown>, (fileConfig || {}) as Record<string, unknown>);
