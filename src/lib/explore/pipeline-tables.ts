...
export const KNOWN_PIPELINE_TABLES: Record<string, PackageOutputTable & { label: string }> = {
  ...
  "kraken2-bracken:summary": {
    label: "Top taxon per sample",
    description: "The most abundant species per sample after Bracken re-estimation: its reads and its share of all classified reads.",
    tableKind: "sample-summary",
    format: "tsv",
    sampleColumn: "sample_id",
    roles: { taxon: "top_taxon", taxon_id: "taxonomy_id", rank: "taxonomy_lvl", count: "new_est_reads", value: "fraction_total_reads" },
    columnLabels: { top_taxon: "Top taxon", taxonomy_id: "Taxonomy id", taxonomy_lvl: "Rank", new_est_reads: "Reads (Bracken)", fraction_total_reads: "Share of classified reads" },
  },
  "fastq-checksum:summary": {
    label: "FASTQ checksums",
    tableKind: "sample-summary",
    format: "tsv",
    sampleColumn: "sample_id",
    columnLabels: { checksum1: "R1 md5", checksum2: "R2 md5" },
  },
  "simulate-reads:summary": {
    label: "Read simulation summary",
    tableKind: "sample-summary",
    format: "tsv",
    sampleColumn: "sample_id",
    columnLabels: { read_count1: "R1 reads", read_count2: "R2 reads", read_length: "Read length", insert_mean: "Insert mean", insert_std_dev: "Insert s.d." },
  },
