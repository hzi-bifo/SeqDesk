...
describe("deployment profile capability grants", () => {
  it.each([
    ...
    ["shared-lab", "admin", "operator", "system.facility.manage", false, null],
    ["shared-lab", "admin", "operator", "system.catalog.manage", true, "installation"],
    ["shared-lab", "member", "requester", "system.sequencing.manage", false, null],
    ["shared-lab", "admin", "operator", "system.sequencing.manage", true, "installation"],
    ["shared-lab", "admin", "operator", "support.tickets.use", false, null],
