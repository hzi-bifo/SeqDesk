...
export default function ExploreAnalysisPage() {
  ...
  const restoreRevision = useCallback(
    async (revision: RevisionSummary) => {
      ...
      setBusy("restore");
      try {
        await postJson(`${key}/revisions`, { code: revision.code, params: revision.params, inputs: revision.inputs, fileInputs: revision.fileInputs ?? [], message: `Restored version ${revision.number}` });
